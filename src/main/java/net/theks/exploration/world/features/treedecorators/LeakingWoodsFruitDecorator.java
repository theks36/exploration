...
@EventBusSubscriber
public class LeakingWoodsFruitDecorator extends CocoaDecorator {
	public static MapCodec<LeakingWoodsFruitDecorator> CODEC = MapCodec.unit(LeakingWoodsFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("exploration:leaking_woods_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public LeakingWoodsFruitDecorator() {
		super(0.2f);
	}
