...
@EventBusSubscriber
public class GraveyardTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<GraveyardTrunkDecorator> CODEC = MapCodec.unit(GraveyardTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("exploration:graveyard_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
