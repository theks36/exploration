...
@EventBusSubscriber
public class GraveyardLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<GraveyardLeaveDecorator> CODEC = MapCodec.unit(GraveyardLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("exploration:graveyard_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public GraveyardLeaveDecorator() {
		super(0.25f);
	}
