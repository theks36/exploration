package net.theks.exploration.world.features.treedecorators;
...
@EventBusSubscriber
public class LeakingWoodsLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<LeakingWoodsLeaveDecorator> CODEC = MapCodec.unit(LeakingWoodsLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("exploration:leaking_woods_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public LeakingWoodsLeaveDecorator() {
		super(0.25f);
	}
