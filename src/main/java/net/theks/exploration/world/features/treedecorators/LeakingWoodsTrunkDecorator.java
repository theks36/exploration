...
@EventBusSubscriber
public class LeakingWoodsTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<LeakingWoodsTrunkDecorator> CODEC = MapCodec.unit(LeakingWoodsTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("exploration:leaking_woods_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
