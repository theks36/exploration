...
public class DeadMansSickleItem extends SwordItem {
	...
	public DeadMansSickleItem() {
		super(TOOL_TIER,
				new Item.Properties().attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 7, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
						...
						.add(Attributes.SWEEPING_DAMAGE_RATIO, new AttributeModifier(ResourceLocation.fromNamespaceAndPath(ExplorationMod.MODID, "dead_mans_sickle_0"), 0.5, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
						.add(Attributes.ENTITY_INTERACTION_RANGE, new AttributeModifier(ResourceLocation.fromNamespaceAndPath(ExplorationMod.MODID, "dead_mans_sickle_1"), 0.75, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.exploration.dead_mans_sickle.description_0"));
	}
}